...
The output of a BusProcessing ensemble is always a list of tensors, each
consisting of a list of data tensors and a list of bus tensors. The bus tensors
are constant shape, while the data tensors are of arbitrary nature.
